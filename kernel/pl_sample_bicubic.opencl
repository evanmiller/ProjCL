...
__kernel void pl_sample_image_bicubic(
    ...
    float4 pixel = clamp(pl_interpolate_cubic4(pos.y, 
                                               pl_interpolate_cubic4(pos.x, pixelAA, pixelAB, pixelAC, pixelAD),
                                               pl_interpolate_cubic4(pos.x, pixelBA, pixelBB, pixelBC, pixelBD),
                                               pl_interpolate_cubic4(pos.x, pixelCA, pixelCB, pixelCC, pixelCD),
                                               pl_interpolate_cubic4(pos.x, pixelDA, pixelDB, pixelDC, pixelDD)), (float4)(0.f), (float4)(255.f));
    write_imagef(image_out, (int2)(j, i), pixel);
}

__kernel void pl_sample_image_array_bicubic(
                                            __global float2     *xy_grid,
    ...
    float4 pixelAD = read_imagef(image_in, sampler, (int4)(colD, rowA, colDTile + rowATile * tile_cols_count, 0));
    ...
    float4 pixelDA = read_imagef(image_in, sampler, (int4)(colA, rowD, colATile + rowDTile * tile_cols_count, 0));
    ...
    float4 pixelDD = read_imagef(image_in, sampler, (int4)(colD, rowD, colDTile + rowDTile * tile_cols_count, 0));
    ...
    float4 pixel = clamp(pl_interpolate_cubic4(pos.y,
                                               ...
                                               pl_interpolate_cubic4(pos.x, pixelBA, pixelBB, pixelBC, pixelBD),
                                               pl_interpolate_cubic4(pos.x, pixelCA, pixelCB, pixelCC, pixelCD),
                                               pl_interpolate_cubic4(pos.x, pixelDA, pixelDB, pixelDC, pixelDD)
